...
export const BUNDLED_MODELS: ModelInfo[] = [
  ...
  },
  {
    ...
    supportsStreaming: true,
    isLatest: true,
    tags: ["reasoning", "code", "vision", "flagship"],
    releaseDate: "2025-06-01",
    category: "text",
  },
  {
  ...
  },
  {
    ...
    supportsStreaming: true,
    isLatest: true,
    tags: ["chinese", "reasoning", "flagship"],
...
export const GENERATOR_AFFINITY: { prefix: string; recommended: string[] }[] = [
  ...
  { prefix: "o4",        recommended: ["gpt-5.5-pro", "gpt-5.5", "claude-opus-4-7"] },
  ...
  { prefix: "llama-",    recommended: ["gpt-5.5-pro", "gpt-5.5", "claude-opus-4-7"] },
  { prefix: "glm-",      recommended: ["gpt-5.5-pro", "gpt-5.5", "qwen3-235b-a22b"] },
  { prefix: "qwen-",     recommended: ["gpt-5.5-pro", "gpt-5.5", "qwen3-235b-a22b"] },
  { prefix: "moonshot-", recommended: ["gpt-5.5-pro", "gpt-5.5", "qwen3-235b-a22b"] },
  { prefix: "ernie-",    recommended: ["gpt-5.5-pro", "gpt-5.5", "qwen3-235b-a22b"] },
];
